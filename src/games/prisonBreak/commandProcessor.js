...
export function error(state, command) {
    return updateLog(
        ...
        command,
        <span>
            Sorry I do not understand {command}. Try entering <CommandRef command="help" /> or{' '}
            <CommandRef command="?" /> to see a list of commands.
        </span>
    );
}
...
export function intro(state) {
    return updateLogDirect(
        state,
        <span>
            You wake up in your cell as you have done for the past few weeks, but today something is different. Your
            cell door is open! This is your one chance to escape this prison. I need to move{' '}
...
function restart(state, command) {
    ...
    return updateLog(
        ...
        command,
        <span>
            Are you sure you want to <CommandRef command="restart" /> from the beginning? All saved progress up to this
            point will be lost. (<CommandRef command="yes" /> / <CommandRef command="no" />)
        </span>
    );
}
        ...
        updateState = updateLogDirect(
            ...
            <span>
                <p>
                    ...
                    You may have won your freedom from this prison, but you shall meet your end in the town beyond...{' '}
                    <br />
