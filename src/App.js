                ...
                <Card style={{ alignSelf: 'center', margin: 'auto' }}>
                    <CardContent>
                        <List>
                            ...
                            <ListItem
                                button
                                onClick={() => (window.location.href = 'https://linkin-games.firebaseapp.com/')}
                            >
                            ...
                            <ListItem
                                button
                                onClick={() => (window.location.href = 'https://agra-ranker.herokuapp.com')}
                            >
                            ...
                            <ListItem
                                button
                                onClick={() =>
                                    (window.location.href = 'https://www.linkedin.com/in/scott-brown-246882b')
                                }
                            >
